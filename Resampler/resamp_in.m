...
processor       = 'MINTPY';                                                 % Can be 'ISCE', 'MINTPY', 'MINTPYVEL' 'ROIPAC', or 'GMT'. GMT inputs should be converted to .xyz files prior to running using grd2xyz. Compatible only with MINTPY outputs generated from ISCE
