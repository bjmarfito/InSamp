...
processor       = 'MINTPY';                                                 % Can be 'ISCE', 'ISCE_MAI', 'MINTPY', 'ROIPAC','SYNTHETIC', or 'GMT'. GMT inputs should be convertedto .xyz files prior to running using grd2xyz. Compatible only with MINTPY outputs generated from ISCE
